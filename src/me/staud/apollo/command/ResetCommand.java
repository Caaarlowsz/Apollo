...
public class ResetCommand implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        ...
        for (Player s : PlayerUtil.getOnlinePlayers()) {
            if (s.hasPermission("apollo.reset")) {
                s.sendMessage(ChatColor.translateAlternateColorCodes('&', "&b" + sender.getName() + " &7has reset the &bStatistics &7of &b" + target.getName()));
                return false;
            }
